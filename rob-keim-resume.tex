...
{\bf BlaBlaCar} --  Remote (France) \hfill {\sl Jun 2019 - Present} \\
Engineering Manager
\begin{itemize} \itemsep -2pt
	...
	\item Average team NPS of 52 during my tenure
\end{itemize}

{\bf Agoda} --  Bangkok, Thailand \hfill {\sl Mar 2017 - Sept 2018} \\
Senior Software Engineer
\begin{itemize} \itemsep -2pt
	\item Full stack engineer with focus on UI/UX (React, TypeScript) 
	...
	\item Streamline team functionality by adopting unofficial scrum master role 
